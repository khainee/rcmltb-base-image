...
apt-get install -y python3 python3-pip python3-lxml g++ gcc automake autoconf
apt-get install -y --no-install-recommends aria2 tzdata p7zip-full p7zip-rar xz-utils curl wget pv jq ffmpeg locales neofetch git make unzip libtool libsodium-dev libcurl4-openssl-dev libc-ares-dev swig libssl-dev libcrypto++-dev zlib1g-dev libsqlite3-dev libfreeimage-dev
echo "\n\n\n\n\n\n\n\n"
